        ...
        <div className="lg:flex">
            <div className="left-content flex-1 lg:pr-[30px]">
              ...
              <div className="bg-white p-5 rounded-custom shadow-custom-1 grid grid-cols-1 lg:grid-cols-2 gap-[15px]">
                  <div className="flex">
                      <span className="w-7 h-7 min-w-7 min-h-7 lg:w-10 lg:h-10 lg:min-w-10 lg:min-h-10 mr-3 mt-1.5 block">
                  ...
                  <div className="flex">
                      <span className="w-7 h-7 min-w-7 min-h-7 lg:w-10 lg:h-10 lg:min-w-10 lg:min-h-10 mr-3 mt-1.5 block">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 min-w-7 h-7 lg:w-10 lg:min-w-10 lg:h-10 fill-[#000000]" viewBox="0 0 512 512">
