      ...
      <div className="py-7 lg:py-12 xl:py-20">
        <div className="container mx-auto">
          <div id="faqAccordionExample">
            {/* Faq Item */}
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              <h2 class="mb-0" id="faq-heading1">
                <button class="group relative flex w-full items-center rounded-none border-0 bg-transparent text-font-18 lg:text-font-20 px-5 py-4 text-left text-base text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none [&:not([data-te-collapse-collapsed])]:bg-white [&:not([data-te-collapse-collapsed])]:text-primary [&:not([data-te-collapse-collapsed])]:shadow-border-b "
                  type="button" data-te-collapse-init data-te-target="#faq-collapse1" aria-expanded="false" aria-controls="faq-collapse1">
                  What are macros?
                  <span class="-me-1 ms-auto h-5 w-5 shrink-0 rotate-[-180deg] transition-transform duration-200 ease-in-out group-data-[te-collapse-collapsed]:me-0 group-data-[te-collapse-collapsed]:rotate-0 motion-reduce:transition-none [&>svg]:h-6 [&>svg]:w-6">
              ...
              <div id="faq-collapse1" class="!visible [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item data-te-collapse-show aria-labelledby="faq-heading1" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
            ...
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              ...
              <div id="faq-collapse2" class="!visible hidden [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item aria-labelledby="faq-heading2" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
            ...
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              ...
              <div id="faq-collapse3" class="!visible hidden [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item aria-labelledby="faq-heading3" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
            ...
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              ...
              <div id="faq-collapse4" class="!visible hidden [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item aria-labelledby="faq-heading4" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
            ...
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              ...
              <div id="faq-collapse5" class="!visible hidden [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item aria-labelledby="faq-heading5" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
            ...
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              ...
              <div id="faq-collapse6" class="!visible hidden [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item aria-labelledby="faq-heading6" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
            ...
            <div class="rounded-none border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-transparent">
              ...
              <div id="faq-collapse7" class="!visible hidden [&:not([data-te-collapse-show])]:bg-white [&:not([data-te-collapsing-show])]:bg-white" data-te-collapse-item aria-labelledby="faq-heading7" data-te-parent="#faqAccordionExample">
                <div class="px-5 pb-4">
